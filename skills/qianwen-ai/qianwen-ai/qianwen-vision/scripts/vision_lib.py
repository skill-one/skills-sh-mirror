"""Shared infrastructure for qianwen-vision scripts.

Thin wrapper around qianwen_lib that re-exports common symbols and adds
...
from qianwen_lib import (  # noqa: E402,F401
    chat_url,
    extract_text,
    has_oss_url,
    http_post,
