...
- **Invalid transaction payload**: never repair a payload generated by another CLI command; return to that command's documented preparation flow. Only help validate or re-encode a payload the user authored themselves.
