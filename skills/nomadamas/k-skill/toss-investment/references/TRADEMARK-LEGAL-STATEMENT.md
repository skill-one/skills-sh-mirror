...
따라서 이 명칭은 필요한 범위의 평문으로만 사용하고, 별도 근거 없이 로고, 공식·제휴·후원·인증·파트너 표현을 사용하지 않는다. 각 상표의 권리는 해당 권리자에게 있다. 이 문서는 금융규제, 투자 적합성, API·서비스 약관, 개인정보, 계좌 접근 또는 개별 거래의 적법성을 판단하지 않는다.
