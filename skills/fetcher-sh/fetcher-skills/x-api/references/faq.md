---
name: x-api-faq
description: Frequently asked questions about the X (Twitter) API on fetcher.sh — search, followers, monitoring, and rate limits, answered with exact endpoints.
---
...
[`twitter-api`](../../twitter-api/SKILL.md) hit the exact same host
and endpoints; `twitter-api` leads with "Twitter" wording so agents
