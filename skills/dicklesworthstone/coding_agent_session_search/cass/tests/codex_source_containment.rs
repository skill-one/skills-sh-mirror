...
// The CASS_CODEX_MAX_SOURCE_BYTES policy tests need the full crate (registry,
// assert_cmd, the cass binary) and live in codex_source_budget_override.rs,
// because scripts/test_codex_contract.py compiles this file in a slim crate.
