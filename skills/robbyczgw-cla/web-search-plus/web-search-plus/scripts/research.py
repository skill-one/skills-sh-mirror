...
Ported from hermes-web-search-plus v2.4.0: providers run concurrently with
deterministic result ordering and an optional wall-clock time budget that
gates provider launches and extraction.
"""
