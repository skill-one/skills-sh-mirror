...
- 本地发布验收通过：Claude Opus 5 完成 136 条，Grok 4.6 完成 56 条定向验收；信息与任务硬失败均为零，正向收益各为 5/7。99 项工程测试通过。最终结果、格式恢复记录与覆盖限制见[评测记录](evals/results-v2.5.0.md)。升级不会自动覆盖已有的本地安装。
