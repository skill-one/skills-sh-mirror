...
プロジェクトを登録します。 プロジェクト作成申請が有効な場合は利用できません。
...
IDに該当するプロジェクトを編集します。 プロジェクト変更申請が有効な場合は利用できません。 リクエストに含まれているフィールドのみ更新され、含まれていないフィールドは更新されません。
...
IDに該当するプロジェクトを削除します。 プロジェクト削除申請が有効な場合は利用できません。
