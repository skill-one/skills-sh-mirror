...
各ファイルの xpath 列はレスポンス XML に対してそのまま評価できる。
単独の帳票は `{sheet_code}.md`、別表の系列（別表一・四・五・十一・十六）・内訳書・税務代理権限証書は
1 ファイルに複数の帳票をまとめている（帳票ごとに `##` 見出しで区切られ、直下に `sheet_code` と `様式ID` がある）。

使い方: 調べたい帳票の `sheet_code` または帳票名で下表を引き、該当ファイルだけを開く。
複数の帳票をまとめたファイルでは、`sheet_code` でファイル内を検索して該当帳票の位置を探す。
XTX/XBRL のタグ名から項目の意味を調べる場合も、タグ名でファイル内を検索すれば項目名に辿り着ける。

## 出典と注意事項

- freee の帳票定義（電子申告タグ定義・帳票項目定義）と、e-Tax / eLTAX が配布する様式仕様書をもとに、機械的に生成している
- 対象の様式バージョン: 202512 / 202604
- 各表は様式のテンプレートであり、実際のレスポンスには値が未入力の項目が現れないことがある。ページ番号は代表値として 1 ページ目を表示している
...
| --- | --- | --- | --- |
| `10100100` | 別表一青色 | e-Tax（国税） | [`beppyo-01.md`](./beppyo-01.md) |
| `10100101` | 別表一白色 | e-Tax（国税） | [`beppyo-01.md`](./beppyo-01.md) |
| `10100102` | 別表一次葉 | e-Tax（国税） | [`beppyo-01.md`](./beppyo-01.md) |
| `10100102` | 別表一次葉白色 | e-Tax（国税） | [`beppyo-01.md`](./beppyo-01.md) |
| `10200000` | 別表二 | e-Tax（国税） | [`10200000.md`](./10200000.md) |
| `10040200` | 別表四 | e-Tax（国税） | [`beppyo-04.md`](./beppyo-04.md) |
| `10040100` | 別表四（原則様式） | e-Tax（国税） | [`beppyo-04.md`](./beppyo-04.md) |
| `10050100` | 別表五（一） | e-Tax（国税） | [`beppyo-05.md`](./beppyo-05.md) |
| `10050200` | 別表五（二） | e-Tax（国税） | [`beppyo-05.md`](./beppyo-05.md) |
...
| `11100100` | 別表十一（一） | e-Tax（国税） | [`beppyo-11.md`](./beppyo-11.md) |
| `11100120` | 別表十一（一の二） | e-Tax（国税） | [`beppyo-11.md`](./beppyo-11.md) |
| `11400200` | 別表十四（二） | e-Tax（国税） | [`11400200.md`](./11400200.md) |
| `11500000` | 別表十五 | e-Tax（国税） | [`11500000.md`](./11500000.md) |
| `11600100` | 別表十六（一） | e-Tax（国税） | [`beppyo-16.md`](./beppyo-16.md) |
| `11600200` | 別表十六（二） | e-Tax（国税） | [`beppyo-16.md`](./beppyo-16.md) |
| `11600600` | 別表十六（六） | e-Tax（国税） | [`beppyo-16.md`](./beppyo-16.md) |
| `11600700` | 別表十六（七） | e-Tax（国税） | [`beppyo-16.md`](./beppyo-16.md) |
| `11600800` | 別表十六（八） | e-Tax（国税） | [`beppyo-16.md`](./beppyo-16.md) |
| `402001000` | 適用額明細書 | e-Tax（国税） | [`402001000.md`](./402001000.md) |
| `401001000` | 法人事業概況説明書 | e-Tax（国税） | [`401001000.md`](./401001000.md) |
| `401002001` | 預貯金等の内訳書 | e-Tax（国税） | [`uchiwakesho.md`](./uchiwakesho.md) |
| `401002002` | 受取手形の内訳書 | e-Tax（国税） | [`uchiwakesho.md`](./uchiwakesho.md) |
| `401002003` | 売掛金の内訳書 | e-Tax（国税） | [`uchiwakesho.md`](./uchiwakesho.md) |
| `401002004` | 仮払金・貸付金の内訳書 | e-Tax（国税） | [`uchiwakesho.md`](./uchiwakesho.md) |
| `401002005` | 棚卸資産の内訳書 | e-Tax（国税） | [`uchiwakesho.md`](./uchiwakesho.md) |
| `401002006` | 有価証券の内訳書 | e-Tax（国税） | [`uchiwakesho.md`](./uchiwakesho.md) |
| `401002007` | 固定資産の内訳書 | e-Tax（国税） | [`uchiwakesho.md`](./uchiwakesho.md) |
| `401002008` | 支払手形の内訳書 | e-Tax（国税） | [`uchiwakesho.md`](./uchiwakesho.md) |
| `401002009` | 買掛金の内訳書 | e-Tax（国税） | [`uchiwakesho.md`](./uchiwakesho.md) |
| `401002010` | 仮受金・源泉所得税預り金の内訳書 | e-Tax（国税） | [`uchiwakesho.md`](./uchiwakesho.md) |
| `401002011` | 借入金及び支払利子の内訳書 | e-Tax（国税） | [`uchiwakesho.md`](./uchiwakesho.md) |
| `401002012` | 土地の売上高等の内訳書 | e-Tax（国税） | [`uchiwakesho.md`](./uchiwakesho.md) |
| `401002013` | 売上高等の事業所別内訳書 | e-Tax（国税） | [`uchiwakesho.md`](./uchiwakesho.md) |
| `401002014` | 役員給与等の内訳書 | e-Tax（国税） | [`uchiwakesho.md`](./uchiwakesho.md) |
| `401002015` | 地代家賃等・工業所有権等の使用料の内訳書 | e-Tax（国税） | [`uchiwakesho.md`](./uchiwakesho.md) |
| `401002016` | 雑益・雑損失等の内訳書 | e-Tax（国税） | [`uchiwakesho.md`](./uchiwakesho.md) |
| `403001000` | 税務代理権限証書（国税） | e-Tax（国税） | [`zeimu-dairi-kengen.md`](./zeimu-dairi-kengen.md) |
...
| `403002001` | 税務代理権限証書（都道府県民税） | eLTAX（地方税） | [`zeimu-dairi-kengen.md`](./zeimu-dairi-kengen.md) |
| `403003001` | 税務代理権限証書（市町村民税） | eLTAX（地方税） | [`zeimu-dairi-kengen.md`](./zeimu-dairi-kengen.md) |
