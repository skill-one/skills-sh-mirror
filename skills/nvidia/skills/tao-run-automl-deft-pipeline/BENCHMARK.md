# Skill Benchmark: tao-run-automl-deft-pipeline
...
- Dataset digest: `sha256:0f684b060be4bb330d1744e55d0e571afca759726c3ea3305f5aff3d68cd5969` (skill-evaluator-dataset-snapshot/1)
- Attempts per task: 3
...
|---|---|---:|---:|---:|---:|---|
| claude-code | All cases | 69,691 | 312,273 | N/A | N/A | skill 1/1; base 3/3 |
| claude-code | tao-run-automl-deft-pipeline-basic | 69,691 | 312,273 | N/A | N/A | skill 1/1; base 3/3 |
| codex | All cases | 13,942 | 13,534 | +408 | +3.01% | skill 1/1; base 1/1 |
| codex | tao-run-automl-deft-pipeline-basic | 13,942 | 13,534 | +408 | +3.01% | skill 1/1; base 1/1 |
| ALL AGENTS | Dataset aggregate | 83,633 | 325,807 | N/A | N/A | skill 2/2; base 4/4 |
...
- **MEDIUM** QUALITY/quality_correctness: SKILL_SPEC recommended field missing: 'metadata.tags' (`skills/applications/tao-run-automl-deft-pipeline/SKILL.md`)
...
- **MEDIUM** SCHEMA/frontmatter_field_placement: Root field 'tags' is ignored; use 'metadata.tags' (`skills/applications/tao-run-automl-deft-pipeline/SKILL.md`)
