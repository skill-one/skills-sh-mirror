# Skill Benchmark: tao-setup-nvidia-gpu-host
...
- Dataset digest: `sha256:906b47f67164bf4211efaf087e292e7014b9d8923002af0a07a00469b12ae6dc` (skill-evaluator-dataset-snapshot/1)
- Attempts per task: 3
...
| Efficiency | 97.5% — baseline ran, but no comparable score was available; uplift unavailable | 98.1% — baseline ran, but no comparable score was available; uplift unavailable |
...
|---|---|---:|---:|---:|---:|---|
| claude-code | All cases | 68,477 | 92,463 | N/A | N/A | skill 1/1; base 3/3 |
| claude-code | tao-setup-nvidia-gpu-host-basic | 68,477 | 92,463 | N/A | N/A | skill 1/1; base 3/3 |
| codex | All cases | 31,560 | 13,573 | +17,987 | +132.52% | skill 1/1; base 1/1 |
| codex | tao-setup-nvidia-gpu-host-basic | 31,560 | 13,573 | +17,987 | +132.52% | skill 1/1; base 1/1 |
| ALL AGENTS | Dataset aggregate | 100,037 | 106,036 | N/A | N/A | skill 2/2; base 4/4 |
...
- **MEDIUM** QUALITY/quality_correctness: SKILL_SPEC recommended field missing: 'metadata.tags' (`skills/platform/tao-setup-nvidia-gpu-host/SKILL.md`)
- **MEDIUM** SCHEMA/frontmatter_field_placement: Root field 'tags' is ignored; use 'metadata.tags' (`skills/platform/tao-setup-nvidia-gpu-host/SKILL.md`)
