# Skill Benchmark: tao-train-centerpose
...
- Dataset digest: `sha256:8c9306c1db5f60d09b304b060342bac554886b3493acfb625c7664e8f3bea2fb` (skill-evaluator-dataset-snapshot/1)
- Attempts per task: 3
...
|---|---|---:|---:|---:|---:|---|
| claude-code | All cases | 101,135 | 1,055,330 | N/A | N/A | skill 1/1; base 3/3 |
| claude-code | tao-train-centerpose-basic | 101,135 | 1,055,330 | N/A | N/A | skill 1/1; base 3/3 |
| codex | All cases | 30,972 | 13,945 | +17,027 | +122.10% | skill 1/1; base 1/1 |
| codex | tao-train-centerpose-basic | 30,972 | 13,945 | +17,027 | +122.10% | skill 1/1; base 1/1 |
| ALL AGENTS | Dataset aggregate | 132,107 | 1,069,275 | N/A | N/A | skill 2/2; base 4/4 |
...
- **MEDIUM** QUALITY/quality_correctness: SKILL_SPEC recommended field missing: 'metadata.tags' (`skills/models/tao-train-centerpose/SKILL.md`)
- **MEDIUM** SCHEMA/frontmatter_field_placement: Root field 'tags' is ignored; use 'metadata.tags' (`skills/models/tao-train-centerpose/SKILL.md`)
