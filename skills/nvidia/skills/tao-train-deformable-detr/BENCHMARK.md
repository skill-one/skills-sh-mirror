# Skill Benchmark: tao-train-deformable-detr
...
- Dataset digest: `sha256:4f8a34c161384c71c13bf95c9766cdeeb78b868fc9e9c8f42dbe2c0081e049a4` (skill-evaluator-dataset-snapshot/1)
- Attempts per task: 3
...
|---|---|---:|---:|---:|---:|---|
| claude-code | All cases | 104,713 | 943,990 | N/A | N/A | skill 1/1; base 3/3 |
| claude-code | tao-train-deformable-detr-basic | 104,713 | 943,990 | N/A | N/A | skill 1/1; base 3/3 |
| codex | All cases | 69,529 | 14,037 | +55,492 | +395.33% | skill 1/1; base 1/1 |
| codex | tao-train-deformable-detr-basic | 69,529 | 14,037 | +55,492 | +395.33% | skill 1/1; base 1/1 |
| ALL AGENTS | Dataset aggregate | 174,242 | 958,027 | N/A | N/A | skill 2/2; base 4/4 |
...
- **MEDIUM** QUALITY/quality_correctness: SKILL_SPEC recommended field missing: 'metadata.tags' (`skills/models/tao-train-deformable-detr/SKILL.md`)
- **MEDIUM** SCHEMA/frontmatter_field_placement: Root field 'tags' is ignored; use 'metadata.tags' (`skills/models/tao-train-deformable-detr/SKILL.md`)
