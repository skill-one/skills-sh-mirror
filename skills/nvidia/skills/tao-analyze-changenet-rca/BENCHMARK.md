...
|---|---:|---:|
| Overall | 94.5% — baseline ran, but no comparable score was available; uplift unavailable | 95.4% — baseline ran, but no comparable score was available; uplift unavailable |
...
| Efficiency | 72.6% — baseline ran, but no comparable score was available; uplift unavailable | 98.4% — baseline ran, but no comparable score was available; uplift unavailable |
...
|---|---|---:|---:|---:|---:|---|
| claude-code | All cases | 99,598 | 93,184 | N/A | N/A | skill 1/1; base 3/3 |
| claude-code | tao-analyze-changenet-rca-basic | 99,598 | 93,184 | N/A | N/A | skill 1/1; base 3/3 |
| codex | All cases | 30,273 | 13,608 | +16,665 | +122.46% | skill 1/1; base 1/1 |
| codex | tao-analyze-changenet-rca-basic | 30,273 | 13,608 | +16,665 | +122.46% | skill 1/1; base 1/1 |
| ALL AGENTS | Dataset aggregate | 129,871 | 106,792 | N/A | N/A | skill 2/2; base 4/4 |
...
- **MEDIUM** QUALITY/quality_correctness: SKILL_SPEC recommended field missing: 'metadata.tags' (`skills/applications/tao-analyze-changenet-rca/SKILL.md`)
