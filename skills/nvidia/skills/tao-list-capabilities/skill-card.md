...
Apache 2.0 <br>
## Use Case: <br>
Developers and engineers use this skill to discover available TAO Skill Bank capabilities, supported models, workflow coverage, and AutoML support. <br>
...
**Output Format:** [Plain text capability listings] <br>
...
| Correctness | 0.0% → 100.0% (+100.0 pts) | 40.0% → 70.0% (+30.0 pts) |
| Discoverability | 100.0% | 47.5% |
| Effectiveness | 16.7% → 100.0% (+83.3 pts) | 48.3% → 65.8% (+17.5 pts) |
| Efficiency | 98.6% | 99.1% |
