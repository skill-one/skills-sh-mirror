...
- [基金画线指标](#indicators-line)：`GET /api/fund/indicators/line`
- [基金表格指标](#indicators-table)：`GET /api/fund/indicators/table`
...
<a id="indicators-line"></a>
<a id="indicators-line--基金画线指标"></a>
## 基金画线指标
...
<a id="indicators-table"></a>

<a id="indicators-table--基金表格指标"></a>
## 基金表格指标
