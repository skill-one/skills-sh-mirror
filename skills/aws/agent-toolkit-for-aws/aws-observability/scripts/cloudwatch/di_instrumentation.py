...
USAGE
    ...
    python3 scripts/cloudwatch/di_instrumentation.py <op> --json-file args.json
    python3 scripts/cloudwatch/di_instrumentation.py <op> --json -     # read the JSON object from stdin
    python3 scripts/cloudwatch/di_instrumentation.py <op> --json '{"...": ...}'   # inline (trusted only)
"""
...
def _print_contract() -> int:
    ...
    contract: Dict[str, Any] = {
        ...
        "encoding": "python3 scripts/cloudwatch/di_instrumentation.py <op> --json-file args.json",
        "region": (
