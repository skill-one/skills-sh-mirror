...
USAGE
    ...
    python3 scripts/cloudwatch/di_snapshots.py sample --json -      # read the JSON object from stdin
...
def _print_contract() -> int:
    ...
    contract: Dict[str, Any] = {
        ...
        "encoding": "python3 scripts/cloudwatch/di_snapshots.py <op> --json '{<args>}' [--out FILE]",
        "region": (
